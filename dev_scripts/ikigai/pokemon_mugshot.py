...
def generate_mugshot_data(pokemon_name):
    ...
    mugshot_data = f"""
// {capitalized_name}
static const u32 sFieldMugshotGfx_{capitalized_name}Normal[]            = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/normal.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}NormalShiny[]       = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/normal_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Angry[]             = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/angry.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}AngryShiny[]        = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/angry_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Crying[]            = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/crying.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}CryingShiny[]       = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/crying_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Determined[]        = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/determined.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}DeterminedShiny[]   = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/determined_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Dizzy[]             = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/dizzy.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}DizzyShiny[]        = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/dizzy_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Happy[]             = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/happy.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}HappyShiny[]        = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/happy_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Inspired[]          = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/inspired.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}InspiredShiny[]     = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/inspired_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Joyous[]            = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/joyous.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}JoyousShiny[]       = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/joyous_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Pain[]              = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/pain.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}PainShiny[]         = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/pain_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Sad[]               = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/sad.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}SadShiny[]          = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/sad_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Shouting[]          = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/shouting.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}ShoutingShiny[]     = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/shouting_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Sigh[]              = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/sigh.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}SighShiny[]         = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/sigh_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Stunned[]           = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/stunned.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}StunnedShiny[]      = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/stunned_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Surprised[]         = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/surprised.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}SurprisedShiny[]    = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/surprised_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Teary[]             = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/teary_eyed.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}TearyShiny[]        = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/teary_eyed_shiny.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}Worried[]           = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/worried.4bpp.lz");
static const u32 sFieldMugshotGfx_{capitalized_name}WorriedShiny[]      = INCBIN_U32("graphics/field_mugshots/pokemon/{lower_name}/worried_shiny.4bpp.lz");

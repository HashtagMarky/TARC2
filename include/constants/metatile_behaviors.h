...
enum {
    ...
    MB_OFFICE_CERTIFICATE,
    MB_OFFICE_WATER_COOLER,
    MB_OFFICE_WHITEBOARD_BLANK,
    MB_OFFICE_WHITEBOARD,
    MB_IMPASSABLE_EAST,
    MB_IMPASSABLE_WEST,
    MB_IMPASSABLE_NORTH,
    MB_IMPASSABLE_SOUTH,
    ...
    MB_OFFICE_COFFEE_MACHINE,
    MB_SS_PATHFINDER_TOILET,
    MB_UNUSED_56,
    MB_UNUSED_57,
    MB_UNUSED_58,
    MB_UNUSED_59,

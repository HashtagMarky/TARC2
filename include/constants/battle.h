...
#define ENCOUNTER_LAND          0
#define ENCOUNTER_SURF          1
#define ENCOUNTER_ROCK_SMASH    2
#define ENCOUNTER_OLD_ROD       3
#define ENCOUNTER_GOOD_ROD      4
#define ENCOUNTER_SUPER_ROD     5
#define ENCOUNTER_FIXED         6

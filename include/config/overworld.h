...
#define B_FLAG_FOLLOWERS_DISABLED      FLAG_SUPPRESS_FOLLOWER          // Enables / Disables followers by using a flag. Helpful to disable followers for a period of time.
...
#define OW_FOLLOWERS_ALLOWED_SPECIES (VAR_STARTER_MON)
#define OW_FOLLOWERS_ALLOWED_MET_LVL (5)
#define OW_FOLLOWERS_ALLOWED_MET_LOC (MAPSEC_VYRATON)
...
#define OW_POPUP_BW_TIME_MODE      gSaveBlock2Ptr->optionsClockMode + 1    // Determines what type of time is shown.

...
extern const u8 gText_OptionFontCompact[];  //tx_optionsPlus
extern const u8 gText_OptionFontSpread[];  //tx_optionsPlus
...
extern const u8 gText_Samuel_Welcome[];
extern const u8 gText_Samuel_Castform[];
extern const u8 gText_Samuel_MainSpeech[];
extern const u8 gText_Samuel_TellMeAboutYou[];
extern const u8 gText_Samuel_BoyOrGirl[];
extern const u8 gText_Samuel_ForgottenName[];
extern const u8 gText_Samuel_SoYourePlayer[];
extern const u8 gText_Samuel_JobIsYours[];
extern const u8 gText_Samuel_TravelSafely[];
extern const u8 gText_Samuel_ChooseTones[];

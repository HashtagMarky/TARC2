...
void SetMapVarsToTrainerB(void)
{
    ...
    if (TRAINER_BATTLE_PARAM.opponentA != 0) {
        gSpeakerName = gTrainers[GetCurrentDifficultyLevel()][TRAINER_BATTLE_PARAM.opponentA].trainerName;
    }
}
...
static const u8 *GetIntroSpeechOfApproachingTrainer(void)
{
    if (gApproachingTrainerId == 0) {
        ...
        gSpeakerName = gTrainers[GetCurrentDifficultyLevel()][TRAINER_BATTLE_PARAM.opponentB].trainerName;

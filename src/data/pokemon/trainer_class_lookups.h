const u16 gFacilityClassToPicIndex[] =
{
    ...
    [FACILITY_CLASS_BRENDAN] = TRAINER_PIC_KOLE,
    [FACILITY_CLASS_BRENDAN_2] = TRAINER_PIC_KOLE,
    [FACILITY_CLASS_BRENDAN_3] = TRAINER_PIC_KOLE,
    [FACILITY_CLASS_MAY] = TRAINER_PIC_ANKA,
    [FACILITY_CLASS_MAY_2] = TRAINER_PIC_ANKA,
    [FACILITY_CLASS_MAY_3] = TRAINER_PIC_ANKA,
...
{
    [TRAINER_BACK_PIC_KOLE] = TRAINER_PIC_KOLE,
    [TRAINER_BACK_PIC_ANKA] = TRAINER_PIC_ANKA,

...
u8 MovementAction_EmoteSmiling_Step0(struct ObjectEvent *, struct Sprite *);
...
u8 (*const gMovementActionFuncs_EmoteSmiling[])(struct ObjectEvent *, struct Sprite *);
...
u8 (*const *const gMovementActionFuncs[])(struct ObjectEvent *, struct Sprite *) = {
    ...
    [MOVEMENT_ACTION_EMOTE_SMILING] = gMovementActionFuncs_EmoteSmiling,
...
u8 (*const gMovementActionFuncs_EmoteSmiling[])(struct ObjectEvent *, struct Sprite *) = {
    MovementAction_EmoteSmiling_Step0,
    MovementAction_Finish,
};

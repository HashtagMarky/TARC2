static const struct SpriteFrameImage sPicTable_KoleNormal[] = {
    overworld_ascending_frames(gObjectEventPic_KoleNormalRunning, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_AnkaNormal[] = {
    overworld_ascending_frames(gObjectEventPic_AnkaNormalRunning, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_Brendan[] = {
    overworld_ascending_frames(gObjectEventPic_Brendan, 2, 4),
};

static const struct SpriteFrameImage sPicTable_May[] = {
    overworld_ascending_frames(gObjectEventPic_May, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_Thomas[] = {
    overworld_ascending_frames(gObjectEventPic_Thomas, 2, 4),
};
...
static const struct SpriteFrameImage sPicTable_Joy[] = {
    overworld_ascending_frames(gObjectEventPic_Joy, 2, 4),
};

...
const struct Tileset gTileset_IkigaiOffice =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_IkigaiOffice,
    .palettes = gTilesetPalettes_IkigaiOffice,
    .metatiles = gMetatiles_IkigaiOffice,
...
const struct Tileset gTileset_SSPathfinder_Cabin_Bathroom =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SSPathfinder_Cabin_Bathroom,
...
const struct Tileset gTileset_IkigaiOutdoors =
{
    ...
    .palettes_summer = gTilesetPalettes_IkigaiOutdoors_Summer,
    .palettes_autumn = gTilesetPalettes_IkigaiOutdoors_Autumn,
...
const struct Tileset gTileset_IkigaiOutdoors_Town =
{
    ...
    .palettes_summer = gTilesetPalettes_IkigaiOutdoors_Town_Summer,
    .palettes_autumn = gTilesetPalettes_IkigaiOutdoors_Town_Autumn,
    .palettes_winter = gTilesetPalettes_IkigaiOutdoors_Town_Winter,

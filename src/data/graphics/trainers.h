...
const u32 gTrainerFrontPic_Kole[] = INCBIN_U32("graphics/protagonist_sprites/kole_front_pic.4bpp.smol");
...
const u32 gTrainerFrontPic_Anka[] = INCBIN_U32("graphics/protagonist_sprites/anka_front_pic.4bpp.smol");
...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_KOLE, gTrainerFrontPic_Kole, gTrainerPalette_Kole),
    TRAINER_SPRITE(TRAINER_PIC_ANKA, gTrainerFrontPic_Anka, gTrainerPalette_Anka),
...
const struct SpriteFrameImage gTrainerBackPicTable_Kole[] =
{
    {gTrainerBackPic_Kole + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Kole + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Kole + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Kole + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};

const struct SpriteFrameImage gTrainerBackPicTable_Anka[] =
{
    {gTrainerBackPic_Anka + TRAINER_PIC_SIZE * 0, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Anka + TRAINER_PIC_SIZE * 1, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Anka + TRAINER_PIC_SIZE * 2, TRAINER_PIC_SIZE},
    {gTrainerBackPic_Anka + TRAINER_PIC_SIZE * 3, TRAINER_PIC_SIZE},
};
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_KOLE, 4, gTrainerBackPic_Kole, gTrainerBackPicTable_Kole, gTrainerPalette_Kole, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_ANKA, 4, gTrainerBackPic_Anka, gTrainerBackPicTable_Anka, gTrainerPalette_Anka, sBackAnims_Hoenn),

...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_KOLE, 4, gTrainerBackPic_Kole, gTrainerPalette_Kole, sBackAnims_Hoenn),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_ANKA, 4, gTrainerBackPic_Anka, gTrainerPalette_Anka, sBackAnims_Hoenn),

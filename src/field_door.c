...
static const u8 sDoorAnimTiles_SSPathfinderCabin[] = INCBIN_U8("graphics/door_anims/ss_pathfinder_cabin.4bpp");
...
#define PAL_SS_PATHFINDER_CABIN_WALL 3
...
static const u8 sDoorAnimPalettes_SSPathfinderCabin[] = {
                                                            PAL_SS_PATHFINDER_CABIN_WALL,
                                                            PAL_SS_PATHFINDER_CABIN_WALL,
                                                            PAL_SS_PATHFINDER_CABIN_WALL,
                                                            PAL_SS_PATHFINDER_CABIN_WALL,
                                                            PAL_SS_PATHFINDER_CABIN_WALL,
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_SSPathfinderIndoors_CabinDoor_Unlocked,       DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_SSPathfinderCabin, sDoorAnimPalettes_SSPathfinderCabin},
    {},
};

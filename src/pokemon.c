...
{
    [TRAINER_BACK_PIC_KOLE] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Kole,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
    [TRAINER_BACK_PIC_ANKA] = {
        .tileTag = TAG_NONE,
        .paletteTag = 0,
        .oam = &gOamData_BattleSpritePlayerSide,
        .anims = NULL,
        .images = gTrainerBackPicTable_Anka,
        .affineAnims = gAffineAnims_BattleSpritePlayerSide,
        .callback = SpriteCB_BattleSpriteStartSlideLeft,
    },
...
u32 GetSpeciesPrimaryType(u16 species)
{
    return GetSpeciesType(species, 0);
}

u32 GetSpeciesSecondaryType(u16 species)
{
    return GetSpeciesType(species, 1);
}

bool32 CheckSpeciesOfType(u16 species, u8 type)
{

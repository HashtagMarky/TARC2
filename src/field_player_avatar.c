...
static const u8 sRivalAvatarGfxIds[][GENDER_COUNT] =
{
    ...
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KOLE_UNDERWATER,          OBJ_EVENT_GFX_ANKA_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KOLE_FISHING,             OBJ_EVENT_GFX_ANKA_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KOLE_WATERING,            OBJ_EVENT_GFX_ANKA_WATERING},
...
{
    [PLAYER_AVATAR_STATE_NORMAL]     = {OBJ_EVENT_GFX_KOLE_NORMAL,      OBJ_EVENT_GFX_ANKA_NORMAL},
    [PLAYER_AVATAR_STATE_MACH_BIKE]  = {OBJ_EVENT_GFX_KOLE_MACH_BIKE,   OBJ_EVENT_GFX_ANKA_MACH_BIKE},
    [PLAYER_AVATAR_STATE_ACRO_BIKE]  = {OBJ_EVENT_GFX_KOLE_ACRO_BIKE,   OBJ_EVENT_GFX_ANKA_ACRO_BIKE},
    [PLAYER_AVATAR_STATE_SURFING]    = {OBJ_EVENT_GFX_KOLE_SURFING,     OBJ_EVENT_GFX_ANKA_SURFING},
    [PLAYER_AVATAR_STATE_UNDERWATER] = {OBJ_EVENT_GFX_KOLE_UNDERWATER,  OBJ_EVENT_GFX_ANKA_UNDERWATER},
    [PLAYER_AVATAR_STATE_FIELD_MOVE] = {OBJ_EVENT_GFX_KOLE_FIELD_MOVE,  OBJ_EVENT_GFX_ANKA_FIELD_MOVE},
    [PLAYER_AVATAR_STATE_FISHING]    = {OBJ_EVENT_GFX_KOLE_FISHING,     OBJ_EVENT_GFX_ANKA_FISHING},
    [PLAYER_AVATAR_STATE_WATERING]   = {OBJ_EVENT_GFX_KOLE_WATERING,    OBJ_EVENT_GFX_ANKA_WATERING},
    [PLAYER_AVATAR_STATE_VSSEEKER]   = {OBJ_EVENT_GFX_KOLE_FIELD_MOVE,  OBJ_EVENT_GFX_ANKA_FIELD_MOVE},
};
...
static const u8 sPlayerAvatarGfxToStateFlag[GENDER_COUNT][5][2] =
{
    [MALE] =
    {
        {OBJ_EVENT_GFX_KOLE_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_KOLE_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_KOLE_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_KOLE_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_KOLE_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [FEMALE] =
    {
        {OBJ_EVENT_GFX_ANKA_NORMAL,         PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_ANKA_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_ANKA_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_ANKA_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_ANKA_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    }
};
...
{
    /* Change Rival Avatar GFX to Player Avater GFX for ease in renaming Brendan/May to Kole/Anka
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    switch (gfxId)
    {
    case OBJ_EVENT_GFX_ANKA_NORMAL:
    case OBJ_EVENT_GFX_ANKA_MACH_BIKE:
    case OBJ_EVENT_GFX_ANKA_ACRO_BIKE:
    case OBJ_EVENT_GFX_ANKA_SURFING:
    case OBJ_EVENT_GFX_ANKA_FIELD_MOVE:
    case OBJ_EVENT_GFX_ANKA_UNDERWATER:
    case OBJ_EVENT_GFX_ANKA_FISHING:
    case OBJ_EVENT_GFX_ANKA_WATERING:
        return FEMALE;
    default:
        return MALE;
    }

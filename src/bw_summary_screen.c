...
const u32 sSummaryScreen_Pal_BW[]                           = INCBIN_U32("graphics/summary_screen/bw/tiles.gbapal");
...
static const u32 sMoveTypes_Pal_BW[]                        = INCBIN_U32("graphics/types_bw/move_types_bw.gbapal");
#endif
...
u8 CreateBWSummaryScreenMoveTypeIcon(u8 x, u8 y, u8 subpriority, u8 palId)
{
    ...
    LoadCompressedSpriteSheet(&sSpriteSheet_TeraType);
    LoadPalette(sMoveTypes_Pal_BW, OBJ_PLTT_ID(palId), 3 * PLTT_SIZE_4BPP);
    return CreateSprite(&sSpriteTemplate_TeraType, x, y, subpriority);
#else
    LoadCompressedSpriteSheet(&gSpriteSheet_MoveTypes);
    LoadPalette(gMoveTypes_Pal, OBJ_PLTT_ID(palId), 3 * PLTT_SIZE_4BPP);

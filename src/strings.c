...
const u8 gText_Samuel_Castform[] = _("And this is one of the friendly faces\nyou'll see around town, Castform.{PAUSE 96}\p");
...
const u8 gText_Font[] = _("TEXT FONT");  //tx_optionsPlus
...
const u8 gText_OptionFontSpread[] = _("SPREAD");    //tx_optionsPlus
const u8 gText_OptionFontCompact[] = _("COMPACT");        //tx_optionsPlus

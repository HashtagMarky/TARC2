...
static const u32 sMenuTiles[] = INCBIN_U32("graphics/social_media/tiles.4bpp.lz");
static const u32 sMenuTilemap[] = INCBIN_U32("graphics/social_media/tilemap.bin.lz");
static const u16 sMenuPalette[] = INCBIN_U16("graphics/social_media/palette.gbapal");
